...
Scope: JSON*QUERY, JSON_QUERY_ARRAY, JSON_VALUE_ARRAY, JSON_TYPE, JSON_KEYS, TO_JSON, TO_JSON_STRING, PARSE_JSON, BOOL/INT64/FLOAT64/STRING/SAFE_TO*\* JSON conversions. Acceptance: tests cover happy path + null path for each.
